"use strict";
/*
 * GlyphCode supervisor bridge — RPC CONTRACT (extension-side mirror; pure; NO
 * vscode, NO node).
 *
...
/**
 * The JSON-RPC dialect tag carried in every envelope. We use a GlyphCode-scoped
 ...
 */
exports.BRIDGE_JSONRPC = 'glyphcode-jsonrpc/1';
/* ============================================================== *
 * RPC METHOD NAMES
 * ============================================================== */
...
function isEnvelope(value) {
    return (typeof value === 'object' &&
        value !== null &&
        value.glyphcode === exports.BRIDGE_JSONRPC);
}
