"use strict";
/*
 * GlyphCode GOVERNED TERMINAL ENV — pure, headlessly-testable env-sanitization for
 ...
 * auth store under HOME (~/.claude, ~/.codex). GlyphCode NEVER holds, injects, or
...
/** Lowercase set of the explicit proxy var names GlyphCode OWNS (set, never inherited). */
 ...
 * EVERYTHING ELSE ({@link isPreservedTerminalEnvName}). The GlyphCode proxy vars are
