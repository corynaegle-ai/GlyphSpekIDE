"use strict";
/*
 * GlyphStudio GOVERNED TERMINAL ENV — pure, headlessly-testable env-sanitization for
 ...
 * auth store under HOME (~/.claude, ~/.codex). GlyphStudio NEVER holds, injects, or
...
/** Lowercase set of the explicit proxy var names GlyphStudio OWNS (set, never inherited). */
 ...
 * EVERYTHING ELSE ({@link isPreservedTerminalEnvName}). The GlyphStudio proxy vars are
