"use strict";
/*
 * GlyphStudio GOVERNED-RUNS TREE — the activity-bar "Governed Runs" view.
 *
 ...
 * Clicking a row runs `glyphstudio.runs.openRun` with the runId, which focuses the
...
exports.OPEN_RUN_COMMAND = 'glyphstudio.runs.openRun';
...
function buildRunTreeItem(summary, iconRoot) {
    ...
    item.contextValue = summary.closed ? 'glyphstudio.run.closed' : 'glyphstudio.run.live';
    item.command = {
