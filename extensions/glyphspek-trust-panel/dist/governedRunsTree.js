"use strict";
/*
 * GlyphSpek GOVERNED-RUNS TREE — the activity-bar "Governed Runs" view.
 *
 ...
 * Clicking a row runs `glyphspek.runs.openRun` with the runId, which focuses the
...
exports.OPEN_RUN_COMMAND = 'glyphspek.runs.openRun';
...
function buildRunTreeItem(summary, iconRoot) {
    ...
    item.contextValue = summary.closed ? 'glyphspek.run.closed' : 'glyphspek.run.live';
    item.command = {
