#!/usr/bin/env bash
# GlyphCode (fork) — embedded vendored-xterm provenance gate.
#
# WHAT THIS CHECKS
...
#     extensions/glyphcode-trust-panel/media/vendor/xterm/
...
VENDOR_DIR="$REPO_ROOT/extensions/glyphcode-trust-panel/media/vendor/xterm"
...
echo "=== GlyphCode embedded vendored-xterm provenance gate ==="
