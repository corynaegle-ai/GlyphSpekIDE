#!/usr/bin/env bash
# GlyphSpek — "no Copilot runtime in the bundle" deny gate.
#
# WHAT THIS CHECKS
...
#   enough for the "GlyphSpek ships no Copilot" guardrail.
#
...
#
# USAGE
#   build/glyphspek/verify-no-copilot.sh [TARGET_DIR]
#
...
echo "=== GlyphSpek no-Copilot-runtime deny gate ==="
echo "target:   $TARGET"
...
if [ "$violations" -gt 0 ]; then
  ...
  echo "        GlyphSpek must ship NO Copilot runtime. Remove @github/copilot*,"
