...
// GlyphStudio inert stub TYPES for @vscode/copilot-api. Pure type declarations
// (the subset the agent host uses), no Copilot runtime. See SECURITY-PATCHES.md GATE-002.
