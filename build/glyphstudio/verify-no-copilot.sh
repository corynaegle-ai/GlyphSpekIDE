#!/usr/bin/env bash
# GlyphStudio — "no Copilot runtime in the bundle" deny gate.
#
# WHAT THIS CHECKS
...
#   enough for the "GlyphStudio ships no Copilot" guardrail.
#
...
#
# USAGE
#   build/glyphstudio/verify-no-copilot.sh [TARGET_DIR]
#
...
echo "=== GlyphStudio no-Copilot-runtime deny gate ==="
echo "target:   $TARGET"
...
if [ "$violations" -gt 0 ]; then
  ...
  echo "        GlyphStudio must ship NO Copilot runtime. Remove @github/copilot*,"
