#!/usr/bin/env bash
# GlyphStudio (fork) — embedded vendored-xterm provenance gate.
#
# WHAT THIS CHECKS
...
#     extensions/glyphstudio-trust-panel/media/vendor/xterm/
...
VENDOR_DIR="$REPO_ROOT/extensions/glyphstudio-trust-panel/media/vendor/xterm"
...
echo "=== GlyphStudio embedded vendored-xterm provenance gate ==="
