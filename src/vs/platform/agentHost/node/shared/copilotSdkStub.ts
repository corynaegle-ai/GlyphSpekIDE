...
/**
 * GlyphSpek-owned inert compatibility layer for `@github/copilot-sdk`.
 *
 ...
 * Copilot SDK as a load-bearing runtime dependency, but GlyphSpek does not use
...
const COPILOT_UNAVAILABLE = 'Copilot is not available in GlyphSpek (the Copilot runtime is intentionally removed; GlyphSpek ships no GitHub Copilot).';
