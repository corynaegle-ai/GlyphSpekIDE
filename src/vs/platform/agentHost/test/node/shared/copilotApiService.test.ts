...
suite('CopilotApiService', () => {
	...
	// GATE-002 (de-Copilot): GlyphStudio ships NO Copilot runtime. The inert `@vscode/copilot-api`
	...
	suite('GATE-002 de-Copilot invariant (CAPI live path is inert)', () => {
		...
		const COPILOT_UNAVAILABLE = /Copilot is not available in GlyphStudio/;
