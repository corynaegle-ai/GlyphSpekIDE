...
/**
 * GlyphSpek PATCH-001 — layered policy source.
 *
 * Merges a GlyphSpek-bundled file policy (the baseline that travels inside the signed
 ...
 * the GlyphSpek-bundled baseline.
 *
