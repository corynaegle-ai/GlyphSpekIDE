...
// GlyphStudio PATCH-006: imports for the upstream Agents-window surfaces are
...
// GlyphStudio PATCH-006: the upstream Microsoft "Agents window" surface is
...
// GlyphStudio PATCH-006: also leave the title-bar "Open in Agents" widget
