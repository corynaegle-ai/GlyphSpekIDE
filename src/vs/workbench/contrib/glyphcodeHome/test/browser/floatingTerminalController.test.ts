 ...
 */
suite('GlyphCode Floating Terminal — controller state machine (T-SESSION)', () => {
	...
	const OK_START: GovernedStartResult = {
		ok: true, runId: 'run-1', env: { HTTPS_PROXY: 'http://127.0.0.1:1', GLYPHCODE_GOVERNED_FLOATING: 'run-1' },
		strictEnv: true, proxyUrl: 'http://127.0.0.1:1', cwd: '/ws', name: 'GlyphCode Governed Terminal (Floating)', message: '',
	};
