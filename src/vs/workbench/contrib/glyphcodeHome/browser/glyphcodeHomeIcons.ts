...
/**
 * GlyphCode brand icon sprite (PATCH-004).
 *
 * Vendored verbatim from `docs/assets/glyphcode-icons.svg` (the same source the
 ...
 */
const GLYPHCODE_HOME_ICON_SYMBOLS: readonly ISpriteSymbol[] = [
	{
		id: 'gs-run',
		viewBox: '0 0 24 24',
		children: [
...
export function createGlyphspekHomeIconSprite(targetDocument: Document): SVGElement {
	...
	for (const symbol of GLYPHCODE_HOME_ICON_SYMBOLS) {
