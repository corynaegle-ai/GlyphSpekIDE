...
// GlyphStudio branding strips the Copilot `defaultChatAgent` block from product.json.
...
export class OnboardingVariationA extends Disposable implements IOnboardingService {
	...
	show(): void {
		// GlyphStudio ships no Copilot, so product.json has no `defaultChatAgent`. The
