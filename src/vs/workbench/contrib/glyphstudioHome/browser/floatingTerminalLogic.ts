...
/*
 * GLYPHSTUDIO FLOATING GOVERNED TERMINAL — PURE logic (no vscode-editor / no DOM imports).
 *
 ...
 * (floatingTerminalLogic.test.ts under src/vs/workbench/contrib/glyphstudioHome/test/browser)
