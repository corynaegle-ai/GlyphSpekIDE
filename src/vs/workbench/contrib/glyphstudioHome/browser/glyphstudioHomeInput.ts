...
/**
 * GlyphStudio Home — the editor input for the full-window landing surface (PATCH-004).
 *
 ...
 */
export const glyphstudioHomeInputTypeId = 'workbench.editors.glyphstudioHomeInput';

export class GlyphspekHomeInput extends EditorInput {

	static readonly ID = glyphstudioHomeInputTypeId;
	static readonly RESOURCE = URI.from({ scheme: Schemas.walkThrough, authority: 'glyphstudio_home' });
	...
	override getName(): string {
		return localize('glyphstudioHome', "GlyphStudio Home");
	}
