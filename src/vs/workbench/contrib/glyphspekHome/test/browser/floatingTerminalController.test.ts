 ...
 */
suite('GlyphSpek Floating Terminal — controller state machine (T-SESSION)', () => {
	...
	const OK_START: GovernedStartResult = {
		ok: true, runId: 'run-1', env: { HTTPS_PROXY: 'http://127.0.0.1:1', GLYPHSPEK_GOVERNED_FLOATING: 'run-1' },
		strictEnv: true, proxyUrl: 'http://127.0.0.1:1', cwd: '/ws', name: 'GlyphSpek Governed Terminal (Floating)', message: '',
	};
