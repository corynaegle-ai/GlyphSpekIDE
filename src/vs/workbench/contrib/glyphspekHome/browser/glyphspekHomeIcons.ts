...
/**
 * GlyphSpek brand icon sprite (PATCH-004).
 *
 * Vendored verbatim from `docs/assets/glyphspek-icons.svg` (the same source the
 ...
 */
const GLYPHSPEK_HOME_ICON_SYMBOLS: readonly ISpriteSymbol[] = [
	{
		id: 'gs-run',
		viewBox: '0 0 24 24',
		children: [
...
export function createGlyphspekHomeIconSprite(targetDocument: Document): SVGElement {
	...
	for (const symbol of GLYPHSPEK_HOME_ICON_SYMBOLS) {
